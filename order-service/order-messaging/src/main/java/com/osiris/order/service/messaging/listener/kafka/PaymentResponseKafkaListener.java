...
import com.osiris.kafka.order.avro.model.PaymentResponseAvroModel;
import com.osiris.kafka.order.avro.model.PaymentStatus;
import com.osiris.order.service.domain.ports.input.message.listener.payment.PaymentResponseMessageListener;
...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
    ...
    public void receive(@Payload List<PaymentResponseAvroModel> messages,
        ...
        messages.forEach(paymentResponseAvroModel -> {
            ...
            }else if(PaymentStatus.CANCELLED == paymentResponseAvroModel.getPaymentStatus() || paymentResponseAvroModel.getPaymentStatus() == PaymentStatus.FAILED){
