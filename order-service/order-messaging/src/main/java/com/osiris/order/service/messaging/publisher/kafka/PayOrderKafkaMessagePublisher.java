...
import com.osiris.kafka.order.avro.model.RestaurantApprovalRequestAvroModel;
...
import com.osiris.order.service.domain.ports.output.message.publisher.restaurantapproval.OrderPaidRestaurantRequestMessagePublisher;
...
public class PayOrderKafkaMessagePublisher implements OrderPaidRestaurantRequestMessagePublisher {
    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            ...
            kafkaProducer.send(orderServiceConfigData.getRestaurantApprovalRequestTopicName(), orderId, restaurantApprovalRequestAvroModel, orderKafkaMessageHelper.getKafkaCallback(
            ...
            log.error("Error while sending RestaurantApprovalRequestAvroModel message to kafka with order id: {}, error: {}", orderId, ex.getMessage());
        }
    }
}
