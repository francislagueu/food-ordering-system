...
import com.osiris.order.service.domain.dto.create.OrderItem;
...
import com.osiris.order.service.domain.mapper.OrderDataMapper;
import com.osiris.order.service.domain.ports.input.service.OrderApplicationService;
import com.osiris.order.service.domain.ports.output.repository.CustomerRepository;
import com.osiris.order.service.domain.ports.output.repository.OrderRepository;
...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) //permit not using static on before test methods
